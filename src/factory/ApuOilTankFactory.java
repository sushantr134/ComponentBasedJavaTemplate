...
public class ApuOilTankFactory {
    public static Object build() {
        ...
        try {
            ...
            FlightRecorder.instance.insert("ApuOilTankFactory", "ApuOilTank: " + apuOilTankPort.hashCode());
            ...
            FlightRecorder.instance.insert("ApuOilTankFactory","apuOilTankPort: "+apuOilTankPort.hashCode());
        } catch (Exception e) {
            e.printStackTrace();
        }
